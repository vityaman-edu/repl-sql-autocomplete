...
public:
  ...
  CandidatesCollection collectCandidates(size_t caretTokenIndex,
      antlr4::ParserRuleContext* context, size_t timeoutMS,
...
private:
  ...
  bool collectFollowSets(antlr4::atn::ATNState* s,
  ...
  RuleEndStatus processRule(antlr4::atn::RuleStartState* startState,
      size_t tokenListIndex, RuleWithStartTokenList& callStack, int precedence,
      size_t indentation, bool& timedOut);

  std::string generateBaseDescription(antlr4::atn::ATNState* state);
  void printDescription(size_t indentation, antlr4::atn::ATNState* state,
